...
**⚠️ CRITICAL: Never review PRs in HyperBot's own project folder!**
...
8. **NEVER start Codex in ~/.hyperbot/** - it'll read your soul docs and get weird ideas about the org chart!
9. **NEVER checkout branches in ~/Projects/hyperbot/** - that's the LIVE HyperBot instance!
...
For long-running background tasks, append a wake trigger to your prompt so HyperBot gets notified immediately when the agent finishes (instead of waiting for the next heartbeat):

```
... your task here.

When completely finished, run this command to notify me:
hyperbot system event --text "Done: [brief summary of what was built]" --mode now
```
...
When completely finished, run: hyperbot system event --text \"Done: Built todos REST API with CRUD endpoints\" --mode now'"
```
