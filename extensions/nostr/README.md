...
Nostr DM channel plugin for HyperBot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to HyperBot. It enables your bot to:
...
# Configure hyperbot to use local relay
