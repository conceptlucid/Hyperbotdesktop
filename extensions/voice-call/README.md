...
Official Voice Call plugin for **HyperBot**.
...
Docs: `https://docs.hyperbot.ai/plugins/voice-call`
Plugin system: `https://docs.hyperbot.ai/plugin`

## Install (local dev)

### Option A: install via HyperBot (recommended)
...
```bash
mkdir -p ~/.hyperbot/extensions
cp -R extensions/voice-call ~/.hyperbot/extensions/voice-call
cd ~/.hyperbot/extensions/voice-call && pnpm install
```
...
- advanced webhook, streaming, and tunnel notes: `https://docs.hyperbot.ai/plugins/voice-call`

## Stale call reaper

See the plugin docs for recommended ranges and production examples:
`https://docs.hyperbot.ai/plugins/voice-call#stale-call-reaper`

## TTS for calls

Voice Call uses the core `messages.tts` configuration for
streaming speech on calls. Override examples and provider caveats live here:
`https://docs.hyperbot.ai/plugins/voice-call#tts-for-calls`
