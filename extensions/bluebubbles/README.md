...
This directory contains the **BlueBubbles external channel plugin** for HyperBot.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `hyperbot/plugin-sdk` helpers.
