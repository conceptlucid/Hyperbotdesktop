---
description: Update HyperBot from upstream when branch has diverged (ahead/behind)
---

# HyperBot Upstream Sync Workflow
...
```bash
# Kill running app
pkill -x "HyperBot" || true

# Move old version
mv /Applications/HyperBot.app /tmp/HyperBot-backup.app

# Install new build
cp -R dist/HyperBot.app /Applications/

# Launch
open /Applications/HyperBot.app
```
...
# Update hyperbot.json with fallback chains
