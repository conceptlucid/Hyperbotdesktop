...
read_when:
  ...
  - Wiring external systems into Ancient Claw
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your Ancient Claw config directory (typically `~/.ancient-claw/hooks/transforms`).
...
- `ancient-claw webhooks gmail setup` writes `hooks.gmail` config for `ancient-claw webhooks gmail run`.
