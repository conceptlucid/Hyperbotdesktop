...
- Install via CLI: `ancient-claw plugins install @ancient-claw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `ancient-claw plugins install ./extensions/zalo`
   - From npm (if published): `ancient-claw plugins install @ancient-claw/zalo`
...
This page reflects current Ancient Claw behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `ancient-claw pairing list zalo`
  - `ancient-claw pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Ancient Claw.
...
- Example: `ancient-claw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `ancient-claw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `ancient-claw logs --follow`
