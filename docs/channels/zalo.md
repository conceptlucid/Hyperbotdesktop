...
- Install via CLI: `hyperbot plugins install @hyperbot/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `hyperbot plugins install ./extensions/zalo`
   - From npm (if published): `hyperbot plugins install @hyperbot/zalo`
...
This page reflects current HyperBot behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `hyperbot pairing list zalo`
  - `hyperbot pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in HyperBot.
...
- Example: `hyperbot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `hyperbot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `hyperbot logs --follow`
