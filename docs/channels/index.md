---
summary: "Messaging platforms HyperBot can connect to"
read_when:
  - You want to choose a chat channel for HyperBot
...
HyperBot can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- Channels can run simultaneously; configure multiple and HyperBot will route per chat.
