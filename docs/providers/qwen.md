---
summary: "Use Qwen OAuth (free tier) in Ancient Claw"
read_when:
  - You want to use Qwen with Ancient Claw
...
If you already logged in with the Qwen Code CLI, Ancient Claw will sync credentials
