---
summary: "Use Qwen OAuth (free tier) in HyperBot"
read_when:
  - You want to use Qwen with HyperBot
...
If you already logged in with the Qwen Code CLI, HyperBot will sync credentials
