---
title: "Kilo Gateway"
summary: "Use Kilo Gateway's unified API to access many models in Ancient Claw"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in Ancient Claw
---
...
```bash
ancient-claw onboard --kilocode-api-key <key>
```
...
Ancient Claw dynamically discovers available models from the Kilo Gateway at startup. Use
