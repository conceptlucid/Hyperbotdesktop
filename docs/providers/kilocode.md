---
title: "Kilo Gateway"
summary: "Use Kilo Gateway's unified API to access many models in HyperBot"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in HyperBot
---
...
```bash
hyperbot onboard --kilocode-api-key <key>
```
...
HyperBot dynamically discovers available models from the Kilo Gateway at startup. Use
