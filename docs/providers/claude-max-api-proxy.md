...
You can point HyperBot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or HyperBot
...
- [Anthropic provider](/providers/anthropic) - Native HyperBot integration with Claude setup-token or API keys
