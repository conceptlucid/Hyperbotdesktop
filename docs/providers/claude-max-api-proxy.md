...
You can point Ancient Claw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Ancient Claw
...
- [Anthropic provider](/providers/anthropic) - Native Ancient Claw integration with Claude setup-token or API keys
