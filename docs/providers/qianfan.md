---
summary: "Use Qianfan's unified API to access many models in Ancient Claw"
read_when:
...
3. Ancient Claw installed on your system
...
4. Copy the API key for use with Ancient Claw

## CLI setup

```bash
ancient-claw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Ancient Claw Configuration](/gateway/configuration)
