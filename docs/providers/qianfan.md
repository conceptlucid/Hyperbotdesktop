---
summary: "Use Qianfan's unified API to access many models in HyperBot"
read_when:
...
3. HyperBot installed on your system
...
4. Copy the API key for use with HyperBot

## CLI setup

```bash
hyperbot onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [HyperBot Configuration](/gateway/configuration)
