---
summary: "Get Ancient Claw installed and run your first chat in minutes."
read_when:
...
Install Ancient Claw, run onboarding, and chat with your AI assistant — all in
...
<Accordion title="Advanced: environment variables">
  If you run Ancient Claw as a service account or want custom paths:
