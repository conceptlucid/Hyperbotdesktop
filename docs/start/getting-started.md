---
summary: "Get HyperBot installed and run your first chat in minutes."
read_when:
...
Install HyperBot, run onboarding, and chat with your AI assistant — all in
...
<Accordion title="Advanced: environment variables">
  If you run HyperBot as a service account or want custom paths:
