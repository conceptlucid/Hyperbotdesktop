---
summary: "First-run setup flow for Ancient Claw (macOS app)"
read_when:
...
- By default, Ancient Claw is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give Ancient Claw">
...
<Step title="CLI">
  ...
  The app can install the global `ancient-claw` CLI via npm/pnpm so terminal
