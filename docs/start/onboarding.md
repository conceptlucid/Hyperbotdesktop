---
summary: "First-run setup flow for HyperBot (macOS app)"
read_when:
...
- By default, HyperBot is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give HyperBot">
...
<Step title="CLI">
  ...
  The app can install the global `hyperbot` CLI via npm/pnpm so terminal
