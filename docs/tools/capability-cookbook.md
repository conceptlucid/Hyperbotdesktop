---
summary: "Contributor guide for adding a new shared capability to the Ancient Claw plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Ancient Claw core developers. If you are
  building an external plugin, see [Building Plugins](/plugins/building-plugins)
  instead.
</Info>

Use this when Ancient Claw needs a new domain such as image generation, video
