...
It is modeled after Claude Code's `/btw` behavior, but adapted to Ancient Claw's
...
If the main run is currently active, Ancient Claw snapshots the current message
