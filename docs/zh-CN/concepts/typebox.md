...
- 生成的 Swift 模型：`apps/macos/Sources/Ancient ClawProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/ancient-claw/ancient-claw/main/dist/protocol.schema.json
