---
read_when:
  - 你想将 Vercel AI Gateway 与 Ancient Claw 一起使用
...
- Ancient Claw 会自动发现 Gateway 的 `/v1/models` 目录，因此 `/models vercel-ai-gateway`
...
Ancient Claw 接受 Vercel Claude 简写模型引用，并会在运行时将其规范化：
