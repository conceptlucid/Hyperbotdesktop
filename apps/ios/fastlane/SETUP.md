# fastlane setup (Ancient Claw iOS)
...
ASC_KEYCHAIN_SERVICE=ancient-claw-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.ancient-claw.client
# or
...
- The beta flow regenerates `apps/ios/Ancient Claw.xcodeproj` from `apps/ios/project.yml` before archiving
