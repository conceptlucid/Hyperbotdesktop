...
ASC_KEYCHAIN_SERVICE=hyperbot-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.hyperbot.client
# or
...
- The beta flow regenerates `apps/ios/HyperBot.xcodeproj` from `apps/ios/project.yml` before archiving
